...
shooter = createSprite(width/2,height -200,75,150);
...
gun1 = createSprite(width/2 + 50,height -240, 50,20);
...
if(gameState === PLAY){
   ...
   fill("yellow");
   text("SCORE: " + score, windowWidth-230,windowHeight-850);

   fill("red");
   text("LIVES: " + lives, windowWidth - 1800, windowHeight - 850);
...
function shootleft(){
   ...
   var bullet_Left= createSprite(width/2-90,height -240,10,10);
...
function shootright(){
   ...
   var bullet_Right= createSprite(width/2+90,height-240,10,10);
